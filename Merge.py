...
DOCS_FILE_ID = '1rWK74DQA42K8VkbW3qPgyPFr8IhFZ4cUdq2z_XcmkiM'
SHEETS_FILE_ID = input ('Please Enter The Sheet ID : ')
Claimant_Name = input ('Please Enter The Claimant Name :')
...
COLUMNS = ['Owner_Name', 'Owner_Address', 'Reported_By', 'Type_of_Account', 'Amount', 'CoOwner', 'Securities', 'Property_ID']
TEXT_SOURCE_DATA = (
